...
static int[][] readMatrixInput(int rows, int cols, Scanner scanner) {
...
static int[][] applyCustomLogic(int[][] matrix)
{
int rows = matrix.length;
int cols = matrix[0].length;
...
public static void main(String[] args) {
    ...
    int[][] outputMatrix1 = applyCustomLogic(outputMatrix);
    System.out.println("\nOutput Matrix:");
    displayMatrix(outputMatrix1);
    scanner.close();
    }
}